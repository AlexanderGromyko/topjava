...
public class MealTestData {
    ...
    public static Meal getInvalidNew() {
        return new Meal(null, of(2020, Month.FEBRUARY, 1, 18, 0), "Созданный ужин", 15000);
    }
    ...
    public static Meal getInvalidUpdated() {
        return new Meal(MEAL1_ID, meal1.getDateTime().plus(2, ChronoUnit.MINUTES), "Обновленный неправильный завтрак", 15000);
    }
}
